...
// header only chain.
func newCanonical(engine consensus.Engine, n int, full bool) (letdb.Database, *BlockChain, error) {
...
func makeHeaderChain(parent *types.Header, n int, engine consensus.Engine, db letdb.Database, seed int) []*types.Header {
...
func makeBlockChain(parent *types.Block, n int, engine consensus.Engine, db letdb.Database, seed int) []*types.Block {
