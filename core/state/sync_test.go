...
// account array.
func checkStateAccounts(t *testing.T, db letdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db letdb.Database, root common.Hash) error {
...
func checkStateConsistency(db letdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(letdb.Database), srcRoot)
