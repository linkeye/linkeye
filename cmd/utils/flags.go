...
import (
	...
	"github.com/linkeye/linkeye/accounts/keystore"
	...
	"github.com/linkeye/linkeye/dashboard"
	"github.com/linkeye/linkeye/les"
	...
	"github.com/linkeye/linkeye/letstats"
	...
	"github.com/linkeye/linkeye/p2p/nat"
	"github.com/linkeye/linkeye/p2p/netutil"
...
var (
	...
	NetworkIdFlag = cli.Uint64Flag{
		...
		Value: let.DefaultConfig.NetworkId,
	}
	...
	defaultSyncMode = let.DefaultConfig.SyncMode
	...
	LightPeersFlag = cli.IntFlag{
		...
		Value: let.DefaultConfig.LightPeers,
	}
	...
	TxPoolPriceLimitFlag = cli.Uint64Flag{
		...
		Value: let.DefaultConfig.TxPool.PriceLimit,
	}
	TxPoolPriceBumpFlag = cli.Uint64Flag{
		Name:  "txpool.pricebump",
		Usage: "Price bump percentage to replace an already existing transaction",
		Value: let.DefaultConfig.TxPool.PriceBump,
	}
	TxPoolAccountSlotsFlag = cli.Uint64Flag{
		Name:  "txpool.accountslots",
		Usage: "Minimum number of executable transaction slots guaranteed per account",
		Value: let.DefaultConfig.TxPool.AccountSlots,
	}
	TxPoolGlobalSlotsFlag = cli.Uint64Flag{
		Name:  "txpool.globalslots",
		Usage: "Maximum number of executable transaction slots for all accounts",
		Value: let.DefaultConfig.TxPool.GlobalSlots,
	}
	TxPoolAccountQueueFlag = cli.Uint64Flag{
		Name:  "txpool.accountqueue",
		Usage: "Maximum number of non-executable transaction slots permitted per account",
		Value: let.DefaultConfig.TxPool.AccountQueue,
	}
	...
	TxPoolLifetimeFlag = cli.DurationFlag{
		...
		Value: let.DefaultConfig.TxPool.Lifetime,
	}
	...
	GasPriceFlag = BigFlag{
		...
		Value: let.DefaultConfig.GasPrice,
	}
	...
	EthStatsURLFlag = cli.StringFlag{
		Name:  "letstats",
		Usage: "Reporting URL of a letstats service (nodename:secret@host:port)",
	}
	...
	GpoBlocksFlag = cli.IntFlag{
		...
		Value: let.DefaultConfig.GPO.Blocks,
	}
	GpoPercentileFlag = cli.IntFlag{
		Name:  "gpopercentile",
		Usage: "Suggested gas price is the given percentile of a set of recent transaction gas prices",
		Value: let.DefaultConfig.GPO.Percentile,
	}
	...
	BFTRequestTimeoutFlag = cli.Uint64Flag{
		...
		Value: let.DefaultConfig.BFT.RequestTimeout,
	}
...
func setEtherbase(ctx *cli.Context, ks *keystore.KeyStore, cfg *let.Config) {
...
func SetP2PConfig(ctx *cli.Context, cfg *p2p.Config) {
	...
	log.Info("Maximum peer count", "LET", ethPeers, "LES", lightPeers, "total", cfg.MaxPeers)
...
func setBFT(ctx *cli.Context, cfg *let.Config) {
...
func RegisterEthService(stack *node.Node, cfg *let.Config) {
	var err error
...
func RegisterEthStatsService(stack *node.Node, url string) {
	if err := stack.Register(func(ctx *node.ServiceContext) (node.Service, error) {
		...
		var ethServ *let.Ethereum
		ctx.Service(&ethServ)

		var lesServ *les.LightEthereum
		ctx.Service(&lesServ)

		return letstats.New(url, ethServ, lesServ)
	}); err != nil {
...
func MakeChainDatabase(ctx *cli.Context, stack *node.Node) letdb.Database {
	var (
...
func MakeChain(ctx *cli.Context, stack *node.Node) (chain *core.BlockChain, chainDb letdb.Database) {
	var err error
	...
	cache := &core.CacheConfig{
		...
		TrieNodeLimit: let.DefaultConfig.TrieCache,
		TrieTimeLimit: let.DefaultConfig.TrieTimeout,
	}
	if ctx.GlobalIsSet(CacheFlag.Name) || ctx.GlobalIsSet(CacheGCFlag.Name) {
...
// new format.
//
// e.g. linkeye account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// linkeye --keystore /tmp/mykeystore --lightkdf account new
//
