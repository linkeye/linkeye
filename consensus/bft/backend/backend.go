...
import (
	...
	bftCore "github.com/linkeye/linkeye/consensus/bft/core"
	"github.com/linkeye/linkeye/consensus/bft/validator"
...
func New(config *bft.Config, privateKey *ecdsa.PrivateKey, db letdb.Database) consensus.BFT {
