...
import (
	...
	"github.com/linkeye/linkeye/accounts/usbwallet"
...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*letapi.SignTransactionResult, error)
...
type SignerUI interface {
	...
	OnApprovedTx(tx letapi.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*letapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := letapi.SignTransactionResult{Raw: rlpdata, Tx: signedTx}
