...
type Database struct {
	diskdb letdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb letdb.Database) *Database {
	return &Database{
		diskdb: diskdb,
...
func (db *Database) commit(hash common.Hash, batch letdb.Batch) error {
	// If the node does not exist, it's a previously committed node
