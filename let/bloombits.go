...
type BloomIndexer struct {
	...
	db  letdb.Database       // database instance to write index data and metadata into
...
func NewBloomIndexer(db letdb.Database, size uint64) *core.ChainIndexer {
	backend := &BloomIndexer{
		db:   db,
		size: size,
	}
	table := letdb.NewTable(db, string(core.BloomBitsIndexPrefix))
