...
import (
	...
	"github.com/linkeye/linkeye/let/fetcher"
...
func NewProtocolManager(config *params.ChainConfig, mode downloader.SyncMode, networkId uint64, mux *event.TypeMux, txpool txPool, engine consensus.Engine, blockchain *core.BlockChain, chaindb letdb.Database) (*ProtocolManager, error) {
...
func (pm *ProtocolManager) Stop() {
	log.Info("Stopping Linkeye protocol")
	...
	log.Info("Linkeye protocol stopped")
}
...
func (pm *ProtocolManager) handle(p *peer) error {
	...
	p.Log().Debug("Linkeye peer connected", "name", p.Name())
