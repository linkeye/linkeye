...
// Syncing provides information when this nodes starts synchronising with the Linkeye network and when it's finished.
...
type SyncingResult struct {
	...
	Status  linkeye.SyncProgress `json:"status"`
}
