...
func newTestLDB() (*letdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "letdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := letdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db letdb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db letdb.Database, t *testing.T) {
	const n = 8
